...
export const teamMembers = [
  {
    ...
    bio: "Dr. Wilson founded QuardCubeLabs in 2008 with a vision to transform how businesses leverage technology. With a Ph.D. in Computer Science and over 25 years of industry experience, he leads the company's strategic direction and innovation initiatives.",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Sarah oversees all technical aspects of the company, from software development to infrastructure solutions. Her background in both software engineering and systems architecture enables her to bridge complex technical concepts with practical business applications.",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Michael leads our security practice, ensuring that all solutions meet the highest standards of security and compliance. With a background in cybersecurity and risk management, he has helped numerous organizations protect their critical assets from evolving threats.",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Jennifer leads our software development team, overseeing the creation of custom applications and solutions for our clients. Her focus on quality, performance, and user experience ensures that our software solutions exceed client expectations.",
    expertise: ["Software Development", "Agile Methodologies", "DevOps", "Quality Assurance"],
  ...
  },
  {
    ...
    role: "Director of Network Solutions",
    image: "/placeholder.svg?height=400&width=400",
    bio: "Robert leads our networking and infrastructure team, designing and implementing robust, scalable network solutions for organizations of all sizes. His expertise in both traditional and software-defined networking enables innovative approaches to connectivity challenges.",
    expertise: ["Network Architecture", "SD-WAN", "Cloud Networking", "Network Security"],
    education: "M.S. in Network Engineering, Georgia Tech",
    socialMedia: {
      linkedin: "#",
      twitter: "#",
    },
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Lisa ensures that our clients receive exceptional service throughout their journey with QuardCubeLabs. She works closely with project teams to ensure that solutions are delivered on time, within budget, and to the highest standards of quality.",
    expertise: ["Project Management", "Client Relationship Management", "Service Delivery", "Quality Assurance"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "David works with clients to understand their business challenges and design comprehensive technology solutions. His broad technical knowledge and business acumen enable him to create architectures that align with strategic objectives while leveraging the latest technologies.",
    expertise: ["Solution Architecture", "Systems Integration", "Cloud Migration", "Technical Strategy"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    bio: "Emily leads our user experience and interface design team, ensuring that all our digital solutions are intuitive, accessible, and visually appealing. Her human-centered design approach focuses on creating meaningful experiences that meet user needs while achieving business goals.",
    expertise: ["User Experience Design", "Interface Design", "Usability Testing", "Design Systems"],
